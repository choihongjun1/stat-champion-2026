...
| 변수명                         | 타입             |   결측률(%) | 정의                                                                                                                                                                                                                                     |
|:----------------------------|:---------------|---------:|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| store_id                    | object         |     0    | 식별자 = '{업종 prefix}_{관리번호}' (config.BUSINESS_TYPES: 일반음식점 GR / 휴게음식점 SR / 미용업 BT). 표준화 파이프라인 licenses_3gu.parquet과 동일 규칙이라 store_id로 직접 join된다. 3구 combined 기준 중복 0건(실측 확인, 업종 간 교차 충돌 포함).                                             |
...
|:--------------|-------:|
| 미용업 3구 외 제외   | 445234 |
| 일반음식점 3구 외 제외 | 461066 |
| 휴게음식점 3구 외 제외 | 626086 |
